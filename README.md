...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/activemq-cpp-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/activemq-cpp-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add activemq-cpp
# for installing globally
pixi global install activemq-cpp
```
...
It is possible to list all of the versions of `activemq-cpp` available on your platform:
...
```
pixi search activemq-cpp --channel conda-forge
```
